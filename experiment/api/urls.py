...
from experiment.api.views import ParticipantFinalQuestionnaireCreateAPIView
...
urlpatterns = [
    ...
    url(r'api/participants/(?P<participant_id>[\d]+)/final_questionnaires/?$', ParticipantFinalQuestionnaireCreateAPIView.as_view()),
