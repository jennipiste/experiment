...
questions = {
    ...
    "Kuivauskaappi": [
        "Moi",
        "Kuinka korkea kuivauskaappi on?",
        "Kuinka kauan lingotun pyykin kuivaus pikakuivauksella kestää?",
        "Mitä pesuainetta kuivauskaapin puhdistukseen voi käyttää?",
    ...
    "Mankeli": [
        "Moi!",
        "Olen katsellut mankelia mutta tarvitsisin vähän lisätietoja, jotta tiedän ostanko sen. Mikä on mankelin syvyys?",
        "Entä mankeliliinan leveys?",
        "Mikä on lakanoiden mankeiloimisaika?",
        "Selvä, kiitos avusta!"
    ],
    "Miekkailu": [
        "Moi!",
    ...
    "Ompelukone": [
        "Moi",
        "Mikä on tässä ompelukoneessa ompelen enimmäisleveys?",
        "Entä mille välille ompelen pituuden voi asettaa siksak-ompelussa?",
        "Kuinka painava kone on?",
        "Kiitos avusta!"
    ],
    "Painepesuri": [
        "Moi!",
        "Mikä on mallin P 130.2 nimellispaine?",
        "Entä nimellisvirrankulutus?",
        "Kuinka pitkä takuu laitteessa on?",
        "Kiitti vastauksista!"
    ],
    "Pyykinpesukone": [
        "Hei!",
    ...
    "Päältäajettava ruohonleikkuri": [
        "Heippa",
        "Haluaisin vertailla kahta ruohonleikkurimallia, LM2148 M ja LM2153 MD. Kummassa näistä on suurempi teho?",
        "Entä onko niiden polttoainesäiliöiden tilavuuksissa eroa?",
        "Mitkä niiden leikkuuleveydet ovat?",
        "Kiitos vastauksista"
    ],
...
ws.write(row, 1, "Question")
ws.write(row, 2, "Answer")
row += 1

for subject, questions in questions.iteritems():
