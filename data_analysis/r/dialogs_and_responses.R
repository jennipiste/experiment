...
data.dialogs.dialogs %>%
	group_by(layout) %>%
	summarise(sd = sd(dialogs_in_condition), dialogs = mean(dialogs_in_condition)) %>%
	print(n=2)
...
data.dialogs.finisheddialogs %>%
	group_by(layout) %>%
	summarise(sd = sd(finished_dialogs_in_condition), dialogs = mean(finished_dialogs_in_condition)) %>%
	print(n=2)
...
data.dialogs.responses %>%
	group_by(layout) %>%
	summarise(sd = sd(responses_in_condition), responses = mean(responses_in_condition)) %>%
	print(n=2)
...
data.dialogs.accuracy %>%
	group_by(layout) %>%
	summarise(sd = sd(accuracy_in_condition), accuracy = mean(accuracy_in_condition)) %>%
	print(n=2)
...
data.dialogs.dialogs.filtered <- data.dialogs.dialogs[which(data.dialogs.dialogs$dialogs_in_condition <= mild.threshold.upper), ]
...
data.dialogs.finisheddialogs.filtered <- data.dialogs.finisheddialogs[which(data.dialogs.finisheddialogs$finished_dialogs_in_condition <= mild.threshold.upper), ]
...
data.dialogs.responses.filtered <- data.dialogs.responses[which(data.dialogs.responses$responses_in_condition <= mild.threshold.upper), ]
...
data.dialogs.accuracy.filtered <- data.dialogs.accuracy[which(data.dialogs.accuracy$accuracy_in_condition <= mild.threshold.upper), ]
